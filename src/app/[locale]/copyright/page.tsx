...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Card Chronicles Wiki',
    description: 'Copyright and intellectual property information for Card Chronicles Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Card Chronicles Wiki',
      description: 'Copyright and intellectual property information for Card Chronicles Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Card Chronicles Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Card Chronicles Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Card Chronicles Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Operator of the Roblox platform</li>
              <li><strong>Chronicle Entertainment</strong> - Developer of the Card Chronicles game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Card Chronicles</strong> - Trademark of Chronicle Entertainment</li>
              <li><strong>Card Chronicles Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Card Chronicles Wiki.
            </p>
            ...
            <p>
              ...
              Card Chronicles Wiki<br />
              Email: <a href="mailto:dmca@cardchronicles.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cardchronicles.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Card Chronicles Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Card Chronicles Wiki (cardchronicles.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@cardchronicles.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@cardchronicles.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@cardchronicles.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cardchronicles.wiki</a>
            </p>
            <p>
